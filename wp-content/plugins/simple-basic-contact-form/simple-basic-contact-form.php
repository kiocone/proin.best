 ...
 * @since 20191009
 */
function scf_input_shortcode( $atts = array(), $content ) {
...
function scf_validate_options($input) {
	...
	// recaptcha
	$input['scf_recaptcha'] = esc_attr($input['scf_recaptcha']);
