...
//social icons
    ...
    $wp_customize->add_control('ripple_archive_meta_enable',array(
      ...
      //Post Setting Option
    $wp_customize->add_section( 'ripple_post_setting_section', array(
        'priority'     => 2,
        'panel'        => 'ripple_general_panel',
        'title'        => esc_html__('Post Settings', 'ripple'),
      ));

    $wp_customize->add_setting('ripple_post_image_enable',array(
        'sanitize_callback' => 'ripple_sanitize_checkbox',
        'default'           => '1',
      ));
    $wp_customize->add_control('ripple_post_image_enable',array(
        'label'             => esc_html__( 'Show/Hide Image on Single Post ', 'ripple' ),
        'type'              => 'checkbox',
        'priority'          =>  1,
        'section'           => 'ripple_post_setting_section'
      ));
